...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  computed: {
    ...
    isUserTyping: function isUserTyping() {
    ...
    isTyping: function isTyping(e) {
      ...
      setTimeout(function () {
        channel.whisper("typing", {
          typing: _this2.user.name + " is Typing"
        });
      }, 1200);
    },
  ...
  created: function created() {
    ...
    }).listen("MessageDeliveredEvent", function (e) {
      var m = _.find(_this3.messages, {
        id: e.message.id
      });

      m.status = e.message.status;
    }).listenForWhisper("typing", function (e) {
      _this3.usertyping = e.typing;
      setTimeout(function () {
        _this3.usertyping = "";
      }, 1200);
    });
...
var render = function() {
  ...
  return _vm.user != null
    ? _c("div", { staticClass: "chat-screen" }, [
        ...
        _c(
          "div",
          {
            ...
            style: [_vm.conversations ? { overflow: "hidden" } : {}]
          },
          [
            _c(
              "transition",
              { attrs: { name: "zoom-fade", mode: "in-out", appear: "" } },
              [
                _c(
                  "div",
                  {
                    staticClass: "col-md-4 pr-4 pr-md-2",
                    class: { "d-sm-none d-none d-md-block": _vm.hideBar },
                    staticStyle: {
                      height: "100%",
                      width: "100%",
                      flex: "1",
                  ...
                  [
                    _c(
                      ...
                      {
                        staticClass:
                          "font-size-16 mb-0 text-truncate p-2 text-center"
                      },
                      [_vm._v("\n          Conversations\n        ")]
                    ),
                    _vm._v(" "),
                    _c("div", {}, [
                      _c(
                        ...
                        _vm._l(_vm.conversations, function(conversation) {
                          return _c("div", { key: conversation.id }, [
                            _c(
                              "div",
                              {
                                staticClass:
                                ...
                                on: {
                                  click: function($event) {
                                    return _vm.openChat(conversation)
                                  }
                                }
                              },
                              [
                                ...
                                _c(
                                  ...
                                  {
                                    staticClass:
                                      "d-flex flex-column justify-content-around pl-2"
                                  },
                                  [
                                    _c("div", [
                                      _vm._v(_vm._s(conversation.receiver.name))
                                    ]),
                                    _vm._v(" "),
                                    _c(
                                      "div",
            ...
            _c("router-view", {
              ...
              on: {
                toggleHideBar: function() {
                  return (this$1.hideBar = !this$1.hideBar)
                }
              }
            })
          ],
